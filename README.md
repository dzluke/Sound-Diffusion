...
2. prompt interpolation: SD generates frames that are interpolations between two points in time. Linear interpolation is done with np.linspace or similar

Thoughts:
- How does setting a seed value affect the images?
